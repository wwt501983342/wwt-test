...
def generate_dynamic_segment_weights(args, pseudo_segment_dict, step=0):
    ...
    for vid_name in pseudo_segment_dict['results']:
        if os.path.isfile(os.path.join('/home/u202120081002013/ACM-Net/data/ActivityNet13/train', vid_name+".npy")):
            feature = np.load(os.path.join('/home/u202120081002013/ACM-Net/data/ActivityNet13/train', vid_name+".npy"))
        elif os.path.isfile(os.path.join('/home/u202120081002013/ACM-Net/data/ActivityNet13/test', vid_name+".npy")):
            feature = np.load(os.path.join('/home/u202120081002013/ACM-Net/data/ActivityNet13/test', vid_name+".npy"))
