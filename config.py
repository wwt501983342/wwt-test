...
_DATASET_HYPER_PARAMS = {
    ...
    "THUMOS":{
        ...
        "data_dir":"/home/u202120081002013/ACM-Net/data/THUMOS14/",
        "test_gt_file":"/home/u202120081002013/ACM-Net/data/THUMOS14/gt.json",
    ...
    "ActivityNet":{
        ...
        "cls_threshold":0.10,
        "test_upgrade_scale":20,
        "data_dir":"/home/u202120081002013/ACM-Net/data/ActivityNet13",
        "test_gt_file":"/home/u202120081002013/ACM-Net/data/ActivityNet13/gt.json",
...
def build_args(dataset=None):
    ...
    parser.add_argument("--no_resume", action="store_true", help='resume from last exp')
